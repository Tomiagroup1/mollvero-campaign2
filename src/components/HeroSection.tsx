...
const HeroSection = () => {
  return (
    <section className="min-h-screen pt-16 bg-background relative overflow-hidden">
      ...
      <svg className="absolute bottom-0 right-[10%] w-[280px] h-[540px] opacity-[0.14]" viewBox="0 0 229.89 446.69" fill="none">
      ...
      <svg className="absolute top-[15%] right-[42%] w-[160px] h-[180px] opacity-[0.10] rotate-[20deg]" viewBox="0 0 253.17 288.09" fill="none">
