          ...
          <div className="relative z-10 lg:w-[50%] flex flex-col gap-6 py-12 lg:py-0 lg:pr-12 overflow-visible">
            ...
            <div className="opacity-0 animate-scale-up" style={{ animationDelay: "0.7s" }}>
              <a
                ...
                className="inline-flex items-center justify-center gap-2 px-10 py-4 rounded-lg bg-mollvero-coral text-white font-semibold text-base transition-all duration-300 hover:scale-[1.04] hover:shadow-2xl hover:shadow-mollvero-coral/30 hover:brightness-110"
              >
                Chcem zľavu 30% →
              </a>
            </div>
