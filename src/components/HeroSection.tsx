...
const HeroSection = () => {
  return (
    <section className="min-h-screen pt-16 bg-background relative overflow-hidden">
      {/* Brand shapes — subtle background decoration */}
      <svg className="absolute -top-10 -left-20 w-[320px] h-[240px] opacity-[0.07]" viewBox="0 0 313.32 233.44" fill="none">
      ...
      <svg className="absolute bottom-20 right-[5%] w-[200px] h-[160px] opacity-[0.06] rotate-12" viewBox="0 0 324.47 254.63" fill="none">
      ...
      <svg className="absolute top-[45%] -left-4 w-[28px] h-[340px] opacity-[0.06]" viewBox="0 0 33.47 413.22" fill="none">
      ...
      <div className="container mx-auto px-6 lg:px-12 relative">
        <div className="flex flex-col lg:flex-row items-center min-h-[calc(100vh-4rem)] gap-0">
          ...
          {/* Left — text content overlapping the image */}
          ...
          <div className="relative lg:absolute lg:right-0 lg:top-0 lg:bottom-0 lg:w-[50%] animate-fade-in" style={{ animationDelay: "0.2s" }}>
            <div className="relative h-full">
              ...
              />
              {/* Brand shape accent on image */}
              <svg className="absolute -bottom-4 -left-6 w-24 h-18 opacity-40" viewBox="0 0 313.32 233.44" fill="none">
              ...
              <svg className="absolute -top-3 -right-2 w-16 h-12 opacity-30 lg:hidden" viewBox="0 0 324.47 254.63" fill="none">
