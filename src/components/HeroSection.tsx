...
const HeroSection = () => {
  return (
    <section className="min-h-screen pt-16 relative bg-gradient-to-br from-background via-muted/30 to-mollvero-beige/20 overflow-visible">
      ...
      {/* Brand wave — top left */}
      <svg className="absolute -top-16 -left-24 w-[700px] h-[550px] opacity-[0.14] animate-float-slow" viewBox="0 0 296.82 235.71" fill="none">
      ...
      <svg className="absolute top-[25%] -left-4 w-[40px] h-[500px] opacity-[0.16] animate-float-slower" viewBox="0 0 33.47 413.22" fill="none">
      ...
      <svg className="absolute -bottom-12 right-[5%] w-[500px] h-[900px] opacity-[0.12] animate-float-slow" style={{ animationDelay: "2s" }} viewBox="0 0 229.89 446.69" fill="none">
