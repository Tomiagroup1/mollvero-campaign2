...
const TrustSection = () => {
  ...
  return (
    <section className="py-24 lg:py-32 bg-background relative overflow-hidden">
      {/* Decorative SVGs */}
      <svg className="absolute -top-16 -left-20 w-[600px] h-[480px] opacity-[0.14] animate-float-slower" viewBox="0 0 296.82 235.71" fill="none">
      ...
      <svg className="absolute -bottom-20 -right-16 w-[450px] h-[800px] opacity-[0.12]" viewBox="0 0 229.89 446.69" fill="none">
