...
const FeaturesSection = () => {
  return (
    <section className="py-24 lg:py-32 bg-muted/40 relative overflow-hidden">
      ...
      <svg className="absolute -top-6 -right-8 w-[320px] h-[250px] opacity-[0.10]" viewBox="0 0 296.82 235.71" fill="none">
      ...
      <svg className="absolute -bottom-8 -left-6 w-[220px] h-[420px] opacity-[0.07]" viewBox="0 0 229.89 446.69" fill="none">
      ...
      <svg className="absolute top-[40%] left-[5%] w-[140px] h-[160px] opacity-[0.05] -rotate-[15deg]" viewBox="0 0 253.17 288.09" fill="none">
